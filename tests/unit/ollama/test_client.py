...
with patch('src.config.load_config') as mock_load_config:
    ...
    from src.ollama.client import OllamaClient, get_default_client
...
class TestOllamaClient(unittest.TestCase):
    ...
    @patch('src.ollama.client.load_config')
    ...
    @patch('src.ollama.client.CONSTANTS', {'MODEL': 'default-model', 'API_TIMEOUT': 30, 'API_MAX_RETRIES': 3})
...
class TestOllamaClientConnection(unittest.TestCase):
    ...
    @patch('src.ollama.client.requests.get')
...
class TestOllamaClientRequests(unittest.TestCase):
    ...
    @patch('src.ollama.client.requests.post')
    ...
    @patch('src.ollama.client.requests.post')
    @patch('src.ollama.client.time.sleep')
...
class TestDefaultClient(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        import src.ollama.client
        src.ollama.client._default_client = None
    ...
    @patch('src.ollama.client.OllamaClient')
